                ...
                <div className="flex justify-center">
                    <div className="w-full sm:w-10/12 md:w-8/12 text-center">
                        <div
                            ...
                            aria-hidden="true"
                        >
                            <h1 className="text-center text-foreground text-6xl sm:text-7xl md:text-8xl pt-6 sm:pt-8 font-heading">
                                404
                            </h1>
                        </div>

                        <div className="mt-[-50px]">
                            <h3 className="text-2xl text-foreground sm:text-3xl font-bold mb-4 font-heading">
